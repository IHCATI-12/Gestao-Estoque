...
@rotas.get("/abaixo-minimo", response_model=list[ProdutoOut])
def get_produtos_abaixo_estoque_minimo(db: Session=Depends(get_db)):
    return repo.list_produtos_abaixo_minimo(db=db)
